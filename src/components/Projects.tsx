...
const Projects = () => {
  const content = {
    title: "Our Projects",
    subtitle:
      "Explore our portfolio of successful construction projects that showcase our expertise across commercial, residential, and industrial sectors.",
  ...
  return (
    <section id="projects" className="py-20 bg-white scroll-mt-32">
