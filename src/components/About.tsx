...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-construction-lightGray">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-construction-steel mb-6 leading-relaxed">
              Craft Construction has been a trusted leader in the construction industry for over 
              25 years. What started as a small family business has grown into a full-service 
              construction company known for delivering exceptional results.
            </p>
            <p className="text-lg text-construction-steel mb-8 leading-relaxed">
              ...
              cutting-edge technology, and an unwavering commitment to safety and quality. 
              From initial planning to final inspection, we're with you every step of the way.
            </p>
            
            <div className="flex flex-wrap gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-construction-orange">25+</div>
                <div className="text-sm text-construction-steel">Years in Business</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-construction-orange">50+</div>
                <div className="text-sm text-construction-steel">Team Members</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-construction-orange">$50M+</div>
                <div className="text-sm text-construction-steel">Projects Value</div>
              </div>
            </div>
          </div>
